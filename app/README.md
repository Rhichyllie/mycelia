...
The `/` route is the MYCELIA home entry surface. The `/mycelia` route is the static product information hub, `/mycelia/static-demo` is the current read-only static demo product surface, and `/mycelia/roadmap` is the static roadmap surface.
