...
The `/` route is the MYCELIA home entry surface. The `/mycelia` route is the static product information hub, and `/mycelia/static-demo` is the current read-only static demo product surface.
