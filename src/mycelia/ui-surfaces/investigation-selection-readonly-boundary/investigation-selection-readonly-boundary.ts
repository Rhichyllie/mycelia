...
} from "../../ui-surfaces/minimal-investigation-ui-surface";
import type {
  PersistedInvestigationReadModelScenario,
} from "../../persistence/persisted-investigation-read-model";
import type { RuntimeRepositoryClient } from "../../persistence/runtime-repository-layer";
