...
import { RUNTIME_SLICE_TECHNICAL_PLAN_NAME } from "../../planning/runtime-slice-technical-plan";
import {
  CorrelationIdSchema,
...
import { AuditRecordKindSchema, AuditOpaqueReferenceSchema } from "../../domain-contracts/audit-record";
...
export const RUNTIME_PERSISTENCE_RECORDS = [
  {
    ...
    related_existing_source_modules: ["src/mycelia/domain-contracts/governed-run/"],
  ...
  },
  {
    ...
    related_existing_source_modules: ["src/mycelia/domain-contracts/policy-decision-gateway/"],
    required_safety_properties: [
      "tenant-scoped",
      "run-linked",
...
export const RUNTIME_PERSISTENCE_MODULE_MAPPING = [
  {
    record: "GovernedRun",
    maps_to: ["src/mycelia/domain-contracts/governed-run/"],
  },
  {
    record: "RuntimeStateSnapshot",
    maps_to: ["src/mycelia/domain-contracts/runtime-state/", "src/mycelia/domain-contracts/state-transition/"],
  },
  {
    record: "PolicyDecisionRecord",
    maps_to: ["src/mycelia/domain-contracts/policy-decision-gateway/"],
  },
  {
    record: "AdmissionDecisionRecord",
    maps_to: ["src/mycelia/domain-contracts/runtime-admission-gateway/"],
  },
  {
  ...
  {
    record: "AuditRecord",
    maps_to: ["src/mycelia/domain-contracts/audit-record/", "src/mycelia/domain-contracts/audit-recorder/"],
  },
