...
const productionFiles = [
  join(
    ...
    "pilot-demo-end-to-end-contract.ts",
  ),
  join(
    process.cwd(),
    "src",
    ...
    "demo",
    "pilot-demo-end-to-end",
    "pilot-demo-end-to-end-presenter.ts",
  ),
  join(
    process.cwd(),
    "src",
    ...
    "demo",
    "pilot-demo-end-to-end",
    "pilot-demo-end-to-end-surface.tsx",
  ),
  join(process.cwd(), "src", "mycelia", "demo", "pilot-demo-end-to-end", "index.ts"),
  join(process.cwd(), "app", "mycelia", "demo", "page.tsx"),
] as const;
...
describe("pilot demo end-to-end source safety", () => {
  it("keeps production source free of API, auth, DB, replay, tool and export behavior", () => {
