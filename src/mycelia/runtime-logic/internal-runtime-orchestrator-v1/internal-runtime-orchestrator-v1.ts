...
} from "../../runtime-logic/replay-dry-run-descriptor-v1";
import { PolicyActionSchema, PolicyPurposeSchema } from "../../domain-contracts/policy-decision-gateway";
import {
  CorrelationIdSchema,
  err,
  ok,
...
export const INTERNAL_RUNTIME_ORCHESTRATOR_V1_MODULE_ALIGNMENT = [
  ...
  "src/mycelia/runtime-logic/replay-dry-run-descriptor-v1/",
] as const;
