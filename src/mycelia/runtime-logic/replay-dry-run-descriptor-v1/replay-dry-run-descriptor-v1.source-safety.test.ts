...
const modulePath = resolve(
  process.cwd(),
  "src/mycelia/runtime-logic/replay-dry-run-descriptor-v1/replay-dry-run-descriptor-v1.ts",
);
...
describe("replay dry-run descriptor v1 source safety", () => {
  it("does not include unsafe runtime, replay, IO, audit writing or service behavior", () => {
