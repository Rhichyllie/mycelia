...
describe("audit commit boundary", () => {
  ...
  it("model preserves out-of-scope boundaries and source alignment", () => {
    ...
    expect(model.module_alignment).toContain("src/mycelia/domain-contracts/audit-record/");
    expect(model.module_alignment).toContain("src/mycelia/domain-contracts/audit-recorder/");
