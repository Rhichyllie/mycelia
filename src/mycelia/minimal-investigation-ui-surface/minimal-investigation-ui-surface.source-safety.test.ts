...
const productionFiles = [
  join(
    ...
    "minimal-investigation-ui-contract.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-fixtures.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-loader.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-mapper.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-presenter.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-readonly-source.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "minimal-investigation-ui-surface",
    "minimal-investigation-ui-surface.tsx",
  ),
...
describe("minimal investigation ui source safety", () => {
  it("keeps production source free of live runtime, DB, API, auth and replay behavior", () => {
