...
- `src/mycelia/shared-kernel/` for canonical identifiers, classifications, and
  Result helpers.
- `src/mycelia/tenancy-boundaries/` for organizational scope constraints.
- `src/mycelia/runtime-identity/` for request origin metadata.
