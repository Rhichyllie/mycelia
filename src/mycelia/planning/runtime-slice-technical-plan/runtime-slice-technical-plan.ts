...
import { PILOT_OFFER_PILOT_PACKAGE } from "../../planning/pilot-offer-package";
...
export const RUNTIME_SLICE_FUTURE_PERSISTENT_ENTITIES = [
  {
    ...
    source_modules: ["src/mycelia/domain-contracts/governed-run/"],
  ...
  },
  {
    ...
    source_modules: ["src/mycelia/domain-contracts/policy-decision-gateway/"],
    frozen_use_case_need:
  ...
  },
  {
    ...
    source_modules: ["src/mycelia/domain-contracts/runtime-admission-gateway/"],
    frozen_use_case_need:
  ...
  },
  {
    ...
    source_modules: ["src/mycelia/domain-contracts/investigation-bundle/"],
    frozen_use_case_need:
  ...
  },
  {
    ...
    source_modules: ["src/mycelia/domain-contracts/replay-plan/"],
    frozen_use_case_need:
...
export const RUNTIME_SLICE_NEXT_IMPLEMENTATION_SEQUENCE = [
  {
    ...
    likely_modules_files: [
      "docs/product/planning/runtime-slice-technical-plan.md",
  ...
  },
  {
    ...
    likely_modules_files: ["src/mycelia/domain-contracts/investigation-bundle/"],
  ...
  },
  {
    ...
    likely_modules_files: ["src/mycelia/domain-contracts/replay-plan/"],
