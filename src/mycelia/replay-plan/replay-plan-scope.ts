...
export const ReplayPlanScopeSchema = z
  .object({
...
export type ReplayPlanScope = z.infer<typeof ReplayPlanScopeSchema>;
export type ReplayPlanScopeInput = z.input<typeof ReplayPlanScopeSchema>;
