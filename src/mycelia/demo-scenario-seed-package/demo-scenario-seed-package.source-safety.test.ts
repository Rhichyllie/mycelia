...
const productionFiles = [
  join(
    ...
    "demo-scenario-seed-contract.ts",
  ),
  join(
    process.cwd(),
    "src",
    "mycelia",
    "demo-scenario-seed-package",
    "demo-scenario-seed-fixtures.ts",
  ),
  join(
    process.cwd(),
    "src",
  ...
  join(
    ...
    "mycelia",
    "demo-scenario-seed-package",
    "demo-scenario-seed-presenter.ts",
  ),
  join(
    process.cwd(),
    "src",
...
describe("demo scenario seed package source safety", () => {
  it("keeps production source free of runtime, DB, API, auth, replay, tools and export behavior", () => {
