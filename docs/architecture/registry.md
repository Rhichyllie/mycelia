...
|---|---|---|---|---|
| Vision/Product Scope | 00, 01 | PRODUCT_DIRECTION_FROZEN_PARTIAL | `docs/product/`, `src/mycelia/initial-use-case-freeze/`, `src/mycelia/pilot-offer-package/`, `src/mycelia/runtime-slice-technical-plan/`, `src/mycelia/internal-runtime-orchestrator-v1/` | First use case, pilot offer, runtime slice plan and in-memory orchestrator are internal planning and descriptor artifacts. |
| Core Runtime | 02 | CONTRACTS_PLAN_AND_PURE_ORCHESTRATOR_ONLY_RUNTIME_NOT_IMPLEMENTED | `src/mycelia/runtime-envelope/`, `src/mycelia/runtime-admission-gateway/`, `src/mycelia/governed-run/`, `src/mycelia/runtime-slice-technical-plan/`, `src/mycelia/governed-run-lifecycle/`, `src/mycelia/internal-runtime-orchestrator-v1/` | Runtime slice technical plan, pure lifecycle transition logic and in-memory descriptor orchestration exist; no runtime kernel or execution pipeline exists yet. |
...
| Product/Commercial Planning | 00, 01, 19 | INTERNAL_PLANNING_AND_PURE_RUNTIME_SLICE_LAYERS_IMPLEMENTED | `docs/product/`, `src/mycelia/initial-use-case-freeze/`, `src/mycelia/pilot-offer-package/`, `src/mycelia/runtime-slice-technical-plan/`, `src/mycelia/governed-run-lifecycle/`, `src/mycelia/policy-admission-v1/`, `src/mycelia/audit-commit-boundary/`, `src/mycelia/approval-gate-v1/`, `src/mycelia/investigation-view-model-v1/`, `src/mycelia/replay-dry-run-descriptor-v1/`, `src/mycelia/internal-runtime-orchestrator-v1/` | Pricing ranges are internal planning assumptions, not guarantees; lifecycle, policy/admission v1, audit commit boundary, approval gate v1, investigation view model v1, replay dry-run descriptor v1 and internal orchestrator v1 are pure in-memory logic only. |
